...
export default function Chats() {
  ...
  //   // Écoute globale pour tous les messages reçus
  //   socket.on("newMessage", (message: Message) => {
  //     // Si le chat du message est sélectionné, mettez à jour les messages
  ...
  //       );
  //     } else {
  //       // Optionnel : Ajouter une logique pour les messages non lus
  //     }
  //   });
  ...
  const selectedChatData = useMemo(() => {
    return chats.data?.find((chat) => chat.id === selectedChat);
...
const ChatsSkeleton = () => {
  return (
    <div className="flex flex-col">
      <div className="flex flex-row p-5 space-x-3 w-full cursor-pointer">
