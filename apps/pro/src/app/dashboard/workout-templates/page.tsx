        ...
        <SidebarLayoutHeader>
          <div className="flex flex-row items-center gap-2 justify-between flex-1 w-full">
            ...
            <div className="flex flex-row items-center space-x-3">
              ...
              <Button asChild>
                <Link href={ROUTES.programTemplate("new")}>
                  <Plus /> Nouveau modèle
                </Link>
              </Button>
            </div>
    ...
    >
      ...
      <div>
        <MrsQuery
          ...
          Data={
                <Link
                  href={ROUTES.programTemplate(workoutTemplate._id as string)}
                ...
                >
                  ...
                  <div className="flex flex-col w-full border-t h-32 overflow-hidden bg-muted relative">
                    {programTemplate.exercises?.map((exercise) => (
                  ...
                  <div className="flex flex-row items-center justify-between w-full px-4  py-2 ">
                    <p className="text-xs text-muted-foreground">
                      {programTemplate.exercises?.length || 0} exercices
                    </p>
                    <p className="text-xs text-muted-foreground">
                      Durée estimée{" "}
                      {formatTime(
                        programTemplate.exercises?.reduce(
                          (acc, exercise) =>
                            acc +
